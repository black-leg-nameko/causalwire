...
Report abusive, harassing, or otherwise unacceptable behavior privately through the contact method on the maintainer's GitHub profile. Do not use the security advisory channel for conduct reports. All complaints will be reviewed and investigated promptly and fairly, and the privacy and safety of the reporter will be respected.
...
1. **Correction** — A private, written warning for inappropriate language or other behavior deemed unprofessional or unwelcome.
